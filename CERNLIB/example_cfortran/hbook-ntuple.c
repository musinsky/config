/*
 * 2025-04-28, Jan Musinsky, last test on Fedora 42 (gcc 15.1.1) Linux x86_64
 *
 ...
 * cernlib-2006/2006/src/cfortran/Examples/hbook-ntuple.c
 */
...
void main()
{
  ...
  HLIMIT(PAWC_SIZE);
  HROPEN(1,"example","hbook-ntuple.hbook","N",record_size,istat);
